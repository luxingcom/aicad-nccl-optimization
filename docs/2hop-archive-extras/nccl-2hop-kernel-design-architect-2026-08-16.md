...
- 生产日志 `/var/log/vllm/nccl-dgxspark01.log`：`GIN/Plugin: Assigned plugin GIN_IB_GDAKI type 3 to comm`（插件分配了！）——但随后：
  ```
...
|---|---|---|---|---|---|
| 01-02 | roceP2p1s0f1, 198.51.100.137↔.2 | **2.42µs** | 4.68µs | 32.4µs | 313µs |
| 01-03 | roceP2p1s0f0, 198.51.100.141↔.2 | **2.42µs** | — | — | — |
| 02-04 | roceP2p1s0f0, 198.51.100.13↔.14 | **2.42µs** | — | — | — |
| 04-03 | roceP2p1s0f1, 198.51.100.139↔.2 | **2.40µs** | — | — | — |
...
- 生产库：`/opt/nccl-ringonly/libnccl.so.2`（2be94172）nm/strings；`/var/log/vllm/nccl-dgxspark01.log`（GIN 插件分配 + Symmetric not supported）
